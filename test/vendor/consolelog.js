...
if (Function.prototype.bind && /^object$|^function$/.test(typeof console) && typeof console.log === 'object' && typeof window.addEventListener === 'function') {
	...
	['assert', 'clear', 'dir', 'error', 'info', 'log', 'profile', 'profileEnd', 'warn'].forEach(function(method) {
		console[method] = this.call(console[method], console);
	}, Function.prototype.bind);

	// Unsupported console methods, fallback to `log`
	['_exception', 'count', 'debug', 'dirxml', 'group', 'groupCollapsed', 'groupEnd', 'table', 'time', 'timeEnd', 'timeline', 'timelineEnd', 'timeStamp', 'trace'].forEach(function(method) {
...
function _log() {
	var log, ua = navigator.userAgent,
			...
			return (!fpb || (fpb && typeof window.addEventListener === 'undefined')) && typeof console === 'object' && typeof console.log === 'object';
		}()),
